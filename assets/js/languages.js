...
const LANGUAGE_DATA = {
  en: {
    ...
    description:
      "I am Javier Perez (Javitech), an expert in DevOps, SRE, and Solution Architect with years of experience in infrastructure optimization and the development of efficient technological solutions. Discover how I can help you transform and scale your business with customized solutions.",
    keywords:
      "javier perez devops aws gcp azure sre site reliability engineer certification cloud pipeline infrastructure planning security cost optimization performance automation architect ai dora kubernetes amazon web services docker containers git security ux usability",

    // Navigation
    languageButton: "🇪🇸 Español",
    sayThanks: "Say thanks ♥️",
    ...
    aboutTitle: "About me",
    aboutText1:
      "I help companies and individuals on software architecture solutions taking into account security, scalability, resilience and cost optimization.",
    aboutText2:
      "From a young age I've been immersed in technology exploring its inner workings and honing my problem-solving skills. With over 15 years of experience in IT including roles as a DevOps Cloud Engineer and Senior Site Reliability Engineer I've thrived in complex dynamic environments.",
    ...
    // Agenda section
    agendaText:
      "Stay updated with the latest tech and business events. Follow my curated agenda for industry insights.",
    agendaButton: "View Event Agenda",

    // Contact section
    contactTitle: "Connect With Me",
    contactText:
      "Let's collaborate on your next project or discuss the latest in DevOps and SRE practices.",

    // Video section
    videoTitle: "Latest Content",
    videoDescription:
      "Check out my latest insights on DevOps, SRE practices, and cloud architecture.",
    ...
    // Say Thanks page
    sayThanksTitle: "Say thanks ♥️",
    sayThanksDescription:
      "Support my work in DevOps, SRE, and technology education.",
    homeButton: "Home",
  },
  ...
  es: {
    ...
    description:
      "Soy Javier Perez (Javitech), un experto en DevOps, SRE y Arquitecto de Soluciones con años de experiencia en optimización de infraestructuras y desarrollo de soluciones tecnológicas eficientes. Descubre cómo puedo ayudarte a transformar y escalar tu negocio con soluciones personalizadas.",
    keywords:
      "javier perez devops aws gcp azure sre ingeniero de confiabilidad del sitio certificación nube pipeline infraestructura planificación seguridad optimización de costos rendimiento automatización arquitecto ai dora kubernetes servicios web de amazon contenedores docker git seguridad ux usabilidad",

    // Navigation
    languageButton: "🇺🇸 English",
    sayThanks: "Dar gracias ♥️",
    calendarLabel: "Agendar reunión",
    discordCommunity: "Comunidad",
    ...
    aboutText1:
      "Ayudo a empresas e individuos en soluciones de arquitectura de software, teniendo en cuenta la seguridad, escalabilidad, resiliencia y optimización de costos.",
    aboutText2:
      "Desde joven, he estado inmerso en la tecnología, explorando su funcionamiento interno y perfeccionando mis habilidades para resolver problemas. Con más de 15 años de experiencia en TI, incluyendo roles como Ingeniero de Nube DevOps y Ingeniero Senior de Confiabilidad del Sitio, he prosperado en entornos complejos y dinámicos.",
    ...
    // Agenda section
    agendaText:
      "Mantente actualizado con los últimos eventos de tecnología y negocios. Sigue mi agenda curada para obtener información de la industria.",
    agendaButton: "Ver Agenda de Eventos",

    // Contact section
    contactTitle: "Conecta Conmigo",
    contactText:
      "Colaboremos en tu próximo proyecto o discutamos las últimas prácticas de DevOps y SRE.",

    // Video section
    videoTitle: "Contenido Más Reciente",
    videoDescription:
      "Echa un vistazo a mis últimas ideas sobre DevOps, prácticas SRE y arquitectura en la nube.",
    ...
    cookieLearnMore: "Conozca más",
    cookieAccept: "Aceptar",
    cookieDecline: "Rechazar",

    // Say Thanks page
    sayThanksTitle: "Dar gracias ♥️",
    sayThanksDescription:
      "Apoya mi trabajo en DevOps, SRE y educación tecnológica.",
    homeButton: "Inicio",
  },
};
...
class LanguageSwitcher {
  ...
  setupLanguageButton() {
    const languageButton =
      document.querySelector('.nav-links a[href*="es/"]') ||
  ...
  applyLanguage(language) {
    ...
    this.updateElement(
      '.nav-links a[href*="say-thanks"], .nav-links a[href*="dar-gracias"]',
      data.sayThanks
    );
    this.updateElement(
      "#discord-link",
      `<i class="fab fa-discord"></i> ${data.discordCommunity}`
    );
    ...
    this.updateElement(
      ...
      `<i class="fas fa-code"></i> ${data.interestsTitle}`
    );
    ...
    if (
      agendaSection &&
      agendaSection.textContent.includes("agenda.javitech.co")
    ) {
    ...
    this.updateElement(
      ".card h2",
      `<i class="fas fa-network-wired"></i> ${data.contactTitle}`,
      false,
      1
    );
    ...
    this.updateElement(
      ".card h2",
      `<i class="fab fa-youtube"></i> ${data.videoTitle}`,
      false,
      2
    );
  ...
  updateFooter(data) {
    ...
    if (footerHeadings[1])
      footerHeadings[1].textContent = data.footerNewsletter;
    ...
    if (newsletterEmail)
      newsletterEmail.placeholder = data.footerNewsletterPlaceholder;
  ...
  updateSayThanksPage(data) {
    ...
    if (
      window.location.pathname.includes("say-thanks") ||
